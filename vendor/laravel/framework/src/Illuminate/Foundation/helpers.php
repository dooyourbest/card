...
if(! function_exists('z_redirect')){
    function z_redirect($url){
        redirect()->route($url)->send();
        die;
    }
}
if(!function_exists('z_true')){
    function z_true($arr){
        return ['status'=>true,'info'=>$arr];
    }
}
if(!function_exists('z_false')){
    function z_false($arr){
        return ['status'=>false,'info'=>$arr];
    }
}
if(!function_exists('trans_array')){
    function trans_array($obj){
        if(count($obj)==1){
